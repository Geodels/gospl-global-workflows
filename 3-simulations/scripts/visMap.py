...
def accuracyScores(obs, sim, elevrange=100.0, all=True):
    ...
    if all:
        ...
        MAE.append(
            mean_absolute_error(land_obs, land_sim, multioutput="uniform_average")
        )
        ...
        MAE.append(
            mean_absolute_error(shelf_obs, shelf_sim, multioutput="uniform_average")
        )
        ...
        R2.append(
            r2_score(
                ocean_obs.ravel(), ocean_sim.ravel(), multioutput="variance_weighted"
            )
        )
        MAE.append(
            mean_absolute_error(
